...
import req_Repo_pkg.Post_request_Repo;
    ...
    public static void post_res_validator(String res_bod,int statusCode) throws IOException {
		    	//Parse response body and its parameters
				JsonPath jspres=new JsonPath(res_bod);
			  ...
			  //parse request body and its parameters
			   JsonPath jspreq=new JsonPath (Post_request_Repo.post_req_tc1());
